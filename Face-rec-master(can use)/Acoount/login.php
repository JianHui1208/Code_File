...
<head>
    ...
    <style type="text/css">
        ...
        .button:hover , a:hover{background-color: #3e8e41}
...
<body>
    ...
    <div class="wrapper">
    <h1><p style="text-align: center; font-size: 40px;">Login</p></h1>
        <div class="InsideDiv">
    ...
    <div class="d1">
      <button class="button"><a href="Home.php">Home Pages</a></button>
    </div>   
</body>
</html>